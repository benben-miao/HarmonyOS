...
public class AbilityDemo extends AbilitySlice {
    @Override
    public void onStart(Intent intent) {
        super.onStart(intent);

        super.setUIContent(com.example.PhoneHap.ResourceTable.Layout_ability_layout);
        Button btnBack = (Button) findComponentById(ResourceTable.Id_back);
        if(btnBack != null) {
